...
class WorkoutViewController: UIViewController, UITextFieldDelegate, SKPaymentTransactionObserver, SKProductsRequestDelegate {
    ...
    let durations = ["8 Mins", "7 Mins", "6 Mins", "6 Mins", "5 Mins", "5 Mins", "7 Mins", "6 Mins", "8 Mins", "6 Mins", "7 Mins", "7 Mins", "6 Mins", "6 Mins", "5 Mins", "6 Mins", "7 Mins", "8 Mins", "8 Mins", "6 Mins", "5 Mins", "7 Mins", "6 Mins", "5 Mins", "5 Mins", "16 Mins", "9 Mins", "10 Mins", "11 Mins", "32 Mins", "16 Mins", "6 Mins", "10 Mins", "23 Mins", "3 Mins", "10 Mins"]
    
    let videoId = ["8cLbCA-o424", "UW8mThzLYsY", "fLzzb_q8wY4", "vctkeSYoq-c", "Od3pKp73zDQ", "_EQicz7a1D8", "ZQLPZev-PV0", "ko5CB_AL3L8", "qjAnKGfJSJQ", "6E2hSkOBLyE", "CmMoFwPgRUk", "uwKUSlEbvVM", "6ozwproCDjE", "UbZhRnDEyUU", "8cLbCA-o424", "8cLbCA-o424", "vySzH9cdDsg", "vySzH9cdDsg", "VXYQGFNgtfU", "0Bl0EPYrlNY", "8cLbCA-o424", "8cLbCA-o424", "8cLbCA-o424", "O0wGJnxgdm0", "UGSxQTQQqhk", "8cLbCA-o424", "8cLbCA-o424", "8cLbCA-o424", "8cLbCA-o424", "8cLbCA-o424", "8cLbCA-o424", "ixR2RUumgHU", "8cLbCA-o424", "8cLbCA-o424", "8cLbCA-o424", "8cLbCA-o424"]
    
    let difficulties = ["Intermediate", "Intermediate", "Beginner", "Beginner", "Beginner", "Advanced", "Beginner", "Intermediate", "Beginner", "Intermediate", "Advanced", "Intermediate", "Advanced", "Intermediate", "Intermediate", "Intermediate", "Beginner", "Beginner", "Intermediate", "Intermediate", "Intermediate", "Intermediate", "Intermediate", "Intermediate", "Advanced", "Intermediate", "Intermediate", "Intermediate", "Intermediate", "Intermediate", "Intermediate", "Beginner", "Beginner", "Intermediate", "Intermediate", "Beginner"]
    
    let descriptions = ["Target your butt from different angles to sculpt your new perfect peach.", "Tighten and tone your abdominals that is quick and efficient.",
                        "Firm your biceps and triceps with innovative exercises that will sculpt your arms.", "Get your rear in gear with a goal to tighten your tummy.", "Burn unwanted calories to slim and trim by elevating your heart rate.", "Tighten and tone your stomach while sculpting your abdominals.", "Shape your back with this high intensity upper body workout.", "Improve your strength and stamina with this full-body circuit.", "Shape and sculpt your new and improved bubble butt with innovative exercises.", "Get the beach body you always wanted before your wear your Summer swimsuit.", "Tighten your buns and sculpt your curves while shaping your booty.", "Eliminate unwanted cellulite by following this high intensity full-body workout.", "Sculpt your assets with a goal to tone, lift and enhance your glutes.", "Improve your strength and endurance with this full-body workout.", "Get the abs you always wanted just in time for Summer.", "Sculpt your new and improved physique with this full-body circuit.", "Sculpt your body with a goal to shape and tone your tush.", "Stimulate your abdominals from different angles to tighten your tummy.", "Round, lift and enhance your booty with fun, creative program design.", "Eliminate back fat and improve your posture while you tone and sculpt your upper body.", "Reduce your waistline with high intensity interval training.", "Tone and shape your legs without using exercise equipment.", "Target your triceps to eliminate arm fat while sculpting your arms.", "Shape your upper body with this creative circuit training routine.", "Elevate your heart rate with an exercise routine that will make your body sweat.", "Spike your heart rate with high intensity interval training.", "Shape your legs that will target your inner thighs, glutes and hamstrings.", "Tone and sculpt your figure with this high intensity full-body circuit.", "Round your glutes and lean your legs with this lower body exercise routine.", "Reduce unwanted body fat around your chest by sculpting your upper body.", "Change and transform your body with this full-body circuit training routine.", "Increase your heart rate to burn those extra calories during this lower body workout.", "Tone your new and improved beach body to shape and sculpt your physique.", "Improve your strength and endurance during this full-body workout.", "Shape your legs with innovative training techniques that will sculpt your lower body.", "Change and transform your physique with this beach body workout."]
    ...
    override func viewDidLoad() {
        ...
        for i in 0...exerciseNames.count-1{
            ...
            if (((i > 0 && i < 17 && i != 8) || (i == 17)) || (i>18 && i<25) || (i == 31) || (i == 34) ){
                
                filters[i] = filters[i]+"5-7 mins"
                
            }else if(i == 0 || i == 18 || i == 26 || i == 27 || i == 28 || i == 32 || i == 35 || i == 8){
            ...
            if ((i >= 0 && i < 6) || (i > 6 && i < 14) || [16, 18, 23, 24, 31].contains(i)) {
                filters[i] = filters[i] + "Abs & Core"
            }
            if [5, 7, 9, 11, 13, 23, 24, 31].contains(i) {
                filters[i] = filters[i] + "Fat Loss"
            }
            if [7, 9, 11, 13, 23, 24, 31].contains(1) {
                filters[i] = filters[i] + "Legs & Thighs"
            }
            if [0, 3, 7, 8, 9, 11, 12, 13, 16, 18, 23, 24, 31].contains(i) {
                filters[i] = filters[i] + "Butt"
            }
            if [0, 1, 3, 6, 8, 10, 12, 16, 18, 19].contains(i) {
                filters[i] = filters[i] + "Stretch"
            }
            if [0, 1, 2, 3, 6, 8, 10, 12, 16, 18, 19].contains(i) {
            ...
            if [6, 7, 9, 11, 13, 19, 23, 24].contains(i) {
                filters[i] = filters[i] + "Back & Chest"
            }
            if [1, 4, 5, 7, 9, 11, 13, 23, 24, 31].contains(i) {
